...
footprint <- function(country = "EU", extension = "Landuse", allocation = "value"){
  ...
  # data.table::fwrite(results, file=paste0("./output/FABIO_hybrid_",country,"_",extension,"_results_",allocation,"-alloc.csv"), sep=",")
  ...
  data.table::fwrite(data, file=paste0("./output/FABIO-hybrid_",country,"_",extension,"_OtherUses_",allocation,"-alloc_summary.csv"), sep=",")
